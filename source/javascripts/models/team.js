...
App.Team.FIXTURES = [
  ...
  {map_id: 6, id: 'CA', name: 'California', nickname: 'Valley Quails', players: [
    {name: 'Ernie Lombardi', position: 'C', team: 'CA', home: 'Oakland', born: '1908', ops: '.8172'},
    {name: 'Mark McGwire', position: '1B', team: 'CA', home: 'Pomona', born: '1963', ops: '.9822'},
    {name: 'Chase Utley', position: '2B', team: 'CA', home: 'Pasadena', born: '1978', ops: '.8707'},
    {name: 'Evan Longoria', position: '3B', team: 'CA', home: 'Downey', born: '1985', ops: '.8696'},
  ...
  {map_id: 36, id: 'NY', name: 'New York', nickname: 'Bluebirds', players: [
    {name: 'Joe Torre', position: 'C', team: 'NY', home: 'Brooklyn', born: '1940', ops: '.8164'},
    {name: 'Lou Gehrig', position: '1B', team: 'NY', home: 'New York', born: '1903', ops: '1.0749'},
    {name: 'Ross Barnes', position: '2B', team: 'NY', home: 'Mount Morris', born: '1850', ops: '.8519'},
    {name: 'John McGraw', position: '3B', team: 'NY', home: 'Truxton', born: '1873', ops: '.8727'},
    {name: 'Alex Rodriguez', position: 'SS', team: 'NY', home: 'New York', born: '1975', ops: '.9414'},
    {name: 'Babe Herman', position: 'LF', team: 'NY', home: 'Buffalo', born: '1903', ops: '.9091'},
    {name: 'Rocky Colavito', position: 'CF', team: 'NY', home: 'New York', born: '1933', ops: '.8471'},
    {name: 'Hack Miller', position: 'RF', team: 'NY', home: 'New York', born: '1894', ops: '.8461'}
  ]},
  ...
  {map_id: 48, id: 'TX', name: 'Texas', nickname: 'Mockingbirds', players: [
    {name: 'Eddie Taubensee', position: 'C', team: 'TX', home: 'Beeville', born: '1968', ops: '.7595'},
    {name: 'Norm Cash', position: '1B', team: 'TX', home: 'Justiceburg', born: '1934', ops: '.8616'},
    {name: 'Rogers Hornsby', position: '2B', team: 'TX', home: 'Winters', born: '1896', ops: '1.0004'},
    {name: 'Eddie Mathews', position: '3B', team: 'TX', home: 'Texarkana', born: '1931', ops: '.8841'},
